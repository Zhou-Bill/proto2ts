...
export interface DetailPriceRule {
  axiosConfig?: AxiosRequestConfig,
   /** 计算规则 */ 
  price_calculate_rule?: PriceCalculateRule
   /** 价格区间 */ 
...
export interface SsuTotalInfo {
  ...
  sku?: Sku
   /** [分类1, 分类2, spu] */ 
  category_infos?: CategoryTreeCache_CategoryInfo[]
   /** 多个报价单的价格 */ 
...
export interface UpdateSkuV2Request {
  ...
  ingredient_basic_prices?: BasicPrice[]
...
export interface ListSpecialBasicPriceV2Response {
  ...
  ingredient_basic_price?: BasicPrice
  paging?: common.PagingResult
}
...
export interface ListBasicPriceV2Response {
  ...
  parent_basic_prices?: BasicPrice[]
}
...
export interface ListSkuHistoryBasicPriceResponse_ReferencePrices {
  axiosConfig?: AxiosRequestConfig,
   /** 历史报价 */ 
  quotation_reference_prices?: ListSkuHistoryBasicPriceResponse_QuotationReferencePrice[]
}
...
export interface GetSkuReferencePricesResponse_ReferencePrices {
  ...
  quotation_reference_prices?: GetSkuReferencePricesResponse_QuotationReferencePrice[]
   /** 历史采购价参考价 */ 
  purchase_reference_prices?: GetSkuReferencePricesResponse_ReferencePrice[]
   /** 历史入库参考价 */ 
  in_stock_reference_prices?: GetSkuReferencePricesResponse_ReferencePrice[]
   /** 参考市场价 */ 
  market_reference_prices?: GetSkuReferencePricesResponse_ReferencePrice[]
   /** 最近生产入库价 */ 
  last_product_in_stock_prices?: GetSkuReferencePricesResponse_ReferencePrice[]
   /** 采购入库价（市场自采） */ 
  last_in_stock_market_prices?: GetSkuReferencePricesResponse_ReferencePrice[]
}
